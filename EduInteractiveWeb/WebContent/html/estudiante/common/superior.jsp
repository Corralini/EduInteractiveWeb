...
<div class="navbar">
        ...
        <a class="active" href="<%=request.getContextPath() + ViewPaths.PRE_HOME_ESTUDIANTE %>" id="home" onclick="getFocus('home')"><img src="<%=request.getContextPath()%>/img/home.png" alt="home"></img><br>inicio</a>
